...
object CljTomcatTp1TnuidSpec {
  ...
  val expected = List(
    ...
    "d159c05f2aa8e1b9",
    "1",
    "a3923850-5a06-11e4-8ed6-0800200c9a66",
...
/** Check that the tnuid parameter overrides the nuid parameter */
class CljTomcatTp1TnuidSpec extends Specification with EnrichJobSpec {
  import EnrichJobSpec._
